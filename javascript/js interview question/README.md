...
Click [to move to Content](#Contenthere)
...
1. ### What are the possible ways to create objects in JavaScript
   ...
   2. **Object's create method:**
      ...
      ```javascript
      var object = Object.create(null); // we are passing null to avoid adding anything in the prototype chain(not even the things that are already there in there by default)
    
      If we wish to pass an object in the prototype of the object we are creating, we pass that object in the create method.
      ...
      let object = Object.create(proto_object);
      ```
      ![object created with create function and 'null' object passed into it](images/__001__.png)
      ![object created with create function and an object is passed into it](images/__002__.png)
   ...
   3. **Object literal syntax:**
      ...
      Object literal property/key values can be of any data type, including array, function, and nested object.
      ```
...
127. ### How do you test for an empty object
     ...
     2. **Using for-in with hasOwnProperty(Pre-ECMA 5):** You can use a for-in loop along with hasOwnProperty.
